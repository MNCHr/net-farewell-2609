...
<div class="wrap wide">
  ...
  <div id="panel" hidden>
    ...
    <section class="card">
      ...
      <div id="stale-banner" class="warn" hidden>
        방금 한 작업은 서버에 반영됐지만, 목록을 다시 불러오지 못해 아래 화면이 최신 상태가 아닐 수 있습니다.
        다시 불러오기 전에는 표 복사와 저장을 쓸 수 없습니다.
        <div id="stale-reason" class="muted"></div>
        <button id="btn-stale-retry" class="ghost">다시 불러오기</button>
      </div>
    ...
    <section class="card">
      ...
      <p class="muted" id="u-saved" hidden></p>
