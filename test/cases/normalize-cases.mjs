...
export const NAME_CASES = [
  ...
  { input: '홍\u200b길동', expected: '홍길동', why: '무자비 공간 U+200B' },
  { input: '홍\u200c길동', expected: '홍길동', why: '무자비 미분리자 U+200C' },
  { input: '홍\u200d길동', expected: '홍길동', why: '무자비 결합자 U+200D' },
  { input: '홍\ufeff길동', expected: '홍길동', why: '바이트 순서 마크 U+FEFF' },
  { input: '',          expected: null,    why: '빈 값' },
  { input: '   ',       expected: null,    why: '공백뿐' },
